...
export const sendAdminReportEmail = async (userEmail, answers, aiReport, resumeBuffer, resumeName) => {
  try {
    ...
    // Convert AI Report to HTML format
    let reportHtml = `
      <div style="background:#f9fafb; padding:20px; border:1px solid #e5e7eb; border-radius:12px; margin-top:20px; font-family: sans-serif;">
        ...
        <h4 style="color:#111827; margin-bottom: 8px; border-top: 1px solid #e5e7eb; pt: 12px;">Critical Issues:</h4>
        ...
        <h4 style="color:#111827; margin-bottom: 8px; border-top: 1px solid #e5e7eb; pt: 12px;">Coach Intervention:</h4>
